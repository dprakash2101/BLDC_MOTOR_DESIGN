...
if (oDefinitionManager.DoesMaterialExist("NdFe30_3DSF1.000_X")) then
else
oDefinitionManager.AddMaterial Array("NAME:NdFe30_3DSF1.000_X", _
  "CoordinateSystemType:=", "Cartesian", Array("NAME:AttachedData"), Array(_
  "NAME:ModifierData"), "permeability:=", "1.04457", Array(_
  "NAME:magnetic_coercivity", "property_type:=", "VectorProperty", _
  "Magnitude:=", "-838000A_per_meter", "DirComp1:=", "1", "DirComp2:=", "0", _
  "DirComp3:=", "0"))
end if
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "DiaYoke", "Value:=", "14mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "46.01266600412133mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "5deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "Library:=", "syslib", Array("NAME:ParamVector", Array("NAME:Pair", _
  "Name:=", "DiaGap", "Value:=", "34.5mm"), Array("NAME:Pair", "Name:=", _
  "DiaYoke", "Value:=", "70mm"), Array("NAME:Pair", "Name:=", "Length", _
  "Value:=", "46.01266600412133mm"), Array("NAME:Pair", "Name:=", "SegAngle", _
  "Value:=", "5deg"), Array("NAME:Pair", "Name:=", "Fractions", "Value:=", _
...
oModule.AssignMaster Array("NAME:Master", "Objects:=", Array("MasterSheet"), _
  ...
  "UPos:=", Array("35mm", "0mm", "0mm")), "ReverseV:=", true)
oModule.AssignSlave Array("NAME:Slave", "Objects:=", Array("SlaveSheet"), _
  Array("NAME:CoordSysVector", "Origin:=", Array("0mm", "0mm", "0mm"), _
  "UPos:=", Array("2.1431318985078682e-015mm", "35mm", "0mm")), "ReverseV:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Hs1", "Value:=", "0.7662009971235445mm"), _
  Array("NAME:Pair", "Name:=", "Hs2", "Value:=", "13.69032780135712mm"), _
  Array("NAME:Pair", "Name:=", "Bs0", "Value:=", "2.5mm"), Array("NAME:Pair", _
  "Name:=", "Bs1", "Value:=", "5.154198111655829mm"), Array("NAME:Pair", _
  "Name:=", "Bs2", "Value:=", "12.49082266863781mm"), Array("NAME:Pair", _
  ...
  "46.01266600412133mm"), Array("NAME:Pair", "Name:=", "InfoCore", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  Array("NAME:Pair", "Name:=", "Slots", "Value:=", "12"), Array("NAME:Pair", _
  "Name:=", "SlotType", "Value:=", "3"), Array("NAME:Pair", "Name:=", "Hs0", _
  "Value:=", "0.5mm"), Array("NAME:Pair", "Name:=", "Hs1", "Value:=", _
  "0.7662009971235445mm"), Array("NAME:Pair", "Name:=", "Hs2", "Value:=", _
  "13.69032780135712mm"), Array("NAME:Pair", "Name:=", "Bs0", "Value:=", _
  "2.5mm"), Array("NAME:Pair", "Name:=", "Bs1", "Value:=", _
  "5.154198111655829mm"), Array("NAME:Pair", "Name:=", "Bs2", "Value:=", _
  "12.49082266863781mm"), Array("NAME:Pair", "Name:=", "Rs", "Value:=", "0mm"), _
  ...
  "46.01266600412133mm"), Array("NAME:Pair", "Name:=", "InfoCoil", "Value:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "LenRegion", "Value:=", "46.01266600412133mm"), Array("NAME:Pair", "Name:=", _
...
oEditor.CreateUserDefinedPart Array("NAME:UserDefinedPrimitiveParameters", _
  ...
  "PartCoordinateSystem:=", "Global", "MaterialName:=", "NdFe30_3DSF1.000_X", _
  "SolveInside:=", true) 
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  ...
  "0", "XAxisXvec:=", "0.92388", "XAxisYvec:=", "0.382683", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "-0.382683", "YAxisYvec:=", "0.92388", "YAxisZvec:=", _
...
oEditor.CreateRelativeCS Array("NAME:RelativeCSParameters", _
  "CoordinateSystemID:=", -1, "OriginX:=", "0", "OriginY:=", "0", "OriginZ:=", _
  "0", "XAxisXvec:=", "-0.382683", "XAxisYvec:=", "-0.92388", "XAxisZvec:=", _
  "0", "YAxisXvec:=", "0.92388", "YAxisYvec:=", "-0.382683", "YAxisZvec:=", _
...
oModule.AssignLengthOp Array("NAME:Length_Main", "RefineInside:=", true, _
  ...
  "RestrictLength:=", true, "MaxLength:=", "14.4mm")
oEditor.ChangeProperty Array("NAME:AllTabs", Array(_
...
oModule.AssignBand Array("NAME:MotionSetup1", "Move Type:=", "Rotate", _
  ...
  "4342.31rpm", "Moment of Inertia:=", 3.58161e-005, "Damping:=", _
  2.16718e-005, "Load Torque:=", _
  "if(speed<136.226, -0.0161656*speed, -299.993/speed)", "Objects:=", Array(_
  "Band"))
